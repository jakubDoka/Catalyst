...
//     fn matches(&self, ctx: &ParsingCtx, kind: TokenKind, span: Span) -> bool {
//         match self {
//             Self::Str(s) => <&str as TokenPattern>::matches(s, ctx, kind, span),
//             Self::Kind(s_kind) => s_kind.matches(ctx, kind, span),
//         }
//     }
